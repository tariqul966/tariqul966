...
- 🔭 I’m currently working on web utilities and server management tools.
- 🌱 I’m exploring advanced backend architectures and automation.
- 👯 I love contributing to open-source projects.
- 💬 Ask me about PHP, HTML/CSS, JavaScript, or MikroTik scripting.

---

### 🛠️ Tech Stack & Tools

- **Languages:** HTML5, CSS3, JavaScript, TypeScript, PHP, Python, Shell Scripting
- **Server & Networking:** MikroTik RouterOS, Flussonic Media Server, HTTP Index Servers
- **Tools & Platforms:** Git, GitHub, EJS

---

### 📂 Featured Projects

- **[url-masking-tool](https://github.com/tariqul966/url-masking-tool)** - A lightweight utility for URL masking using HTML/JS.
- **[iptv-player](https://github.com/tariqul966/iptv-player)** - Web-based IPTV streaming player for m3u/m3u8 playlists.
- **[File-Manager](https://github.com/tariqul966/File-Manager)** - A web-based file management system built with PHP.
- **[Mikrotik](https://github.com/tariqul966/Mikrotik)** - Collection of useful RouterOS scripts for network automation.
...
- 🐙 **GitHub:** [tariqul966](https://github.com/tariqul966)
